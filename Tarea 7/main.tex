...
\begin{tcolorbox}[breakable]
    \subsubsection*{a)}
    Escojemos un sistema tal que vea al péndulo fijo en el eje vertical, consideremos los vectores base:
    \begin{align*}
        \bm{e}_1 &= l(sin\theta,-cos\theta) \\ 
        \bm{e}_2 &= l(cos\theta, sin\theta) \\ 
        \bm{F} &= (0,-mg+\ddot{y})
    \end{align*}
    donde se puede ver:
    \begin{align*}
        \bm{F} \cdot \bm{e}_1 &= lmgcos\theta -\ddot{y}cos\theta
    \end{align*}
    \subsubsection*{b)}
