...
\begin{tcolorbox}[breakable]
    Sea $\bm{x}$ la función que regresa la posición para un tiempo $t$, se tiene:
    \begin{align*}
        \bm{x} &= c\bm{e_r} + h_0sin(wt)\bm{k} \\
...
\begin{tcolorbox}[breakable]
    ...
    , de donde obtenemos:
    \begin{align*}
        v_0 &= \frac{\frac{2}{w^2}cos\frac{\pi}{2} - \frac{2}{w^2} - x_0 - b}{\frac{\pi}{2w}}
    \end{align*}
\end{tcolorbox}
